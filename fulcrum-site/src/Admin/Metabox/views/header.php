<p>
	<label for="subtitle">
		<strong><?php _e( 'Subtitle', 'fulcrum_site' ); ?></strong>
	</label>
...
<p>
	<label for="_header_content">
		<strong><?php _e( 'Header Contents', 'fulcrum_site' ); ?></strong>
	</label>
	<?php
	$args = array(
...
<p class="description">
	<?php _e( 'Enter the content that you want to display in the header under the title.', 'fulcrum_site' ); ?>
</p>